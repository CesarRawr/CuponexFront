...
public class DeleteController implements Initializable {
    ...
    public void initData(int id, PromocionesController controller) {
        this.id = id;
    ...
    private void acceptHandler(ActionEvent event) {
        String path = "promocion/eliminar";

        try {
            String urlServicio = Constante.URL_BASE + path;
            String parametros = "idPromocion="+this.id;
    ...
    @FXML
    private void disableSucursalHandler(ActionEvent event) {
        String path = "promocion/desactivar";
